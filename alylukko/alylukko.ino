...
int ledPinBlue2 = A0;
int ledPinBlue3 = A1;
int hookPin = A5; // puhelun katkaisija
int ledPinRed = 10; //PUNAISEN VALON PINNIPAIKKA
...
int pincode[] = {2, 5, 6, 8, 9, 4};  //OIKEA NÄPPÄIMISTÖN KOODI
...
void correctCode()
{
  ...
  pinMode(A5, INPUT_PULLUP); //tarkistaa sähkövirran puhelun katkaisijasta
  pinMode(12, OUTPUT); //puhelimen kaiutin

  int Val = digitalRead(A5);
  Serial.println(Val);

  while (Val == 0) {
    tone(buzzer, 1100); delay(50); noTone(buzzer); delay(20);
    tone(buzzer, 1100); delay(50); noTone(buzzer); delay(20);
    tone(buzzer, 1100); delay(50); noTone(buzzer); delay(20);
    tone(buzzer, 1100); delay(50); noTone(buzzer); delay(20);
    tone(buzzer, 1100); delay(50); noTone(buzzer); delay(20);
...
void loop() //PÄÄKOODI
{
  ...
  if (montaPitaaArvataOikein > 4) {
    pinMode(ledPinBlue2, OUTPUT);
    digitalWrite(ledPinBlue2, HIGH);
  }
  if (montaPitaaArvataOikein > 5) {
    pinMode(ledPinBlue2, OUTPUT);
    digitalWrite(ledPinBlue2, HIGH);
    pinMode(ledPinBlue3, OUTPUT);
    digitalWrite(ledPinBlue3, HIGH);
  }
